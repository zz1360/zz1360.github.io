import{_ as e,c as n,o as s,a as i}from"./app-CnoWjds5.js";const l={};function r(t,a){return s(),n("div",null,a[0]||(a[0]=[i(`<p>对象晋升到老年代的年龄阈值，可以通过参数 <code>-XX:MaxTenuringThreshold</code> 来设置</p><p>使用 <code>-XX：MaxMetaspaceSize</code> 标志设置最大元空间大小，默认值为 unlimited，这意味着它只受系统内存的限制。</p><p>使用参数：<code>-XX:+PrintGCDetails</code>可以打印GC相关信息。</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token parameter variable">-XX:+UseParallelGC</span>
