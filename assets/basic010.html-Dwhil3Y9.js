import{_ as a,c as i,o as s,a as d}from"./app-CnoWjds5.js";const n={};function l(r,e){return s(),i("div",null,e[0]||(e[0]=[d(`<h2 id="为什么引入泛型-why-use-generics" tabindex="-1"><a class="header-anchor" href="#为什么引入泛型-why-use-generics" aria-hidden="true">#</a> 为什么引入泛型 Why Use Generics?</h2><p>减少重复代码，增加复用</p><h2 id="泛型类-generic-classes" tabindex="-1"><a class="header-anchor" href="#泛型类-generic-classes" aria-hidden="true">#</a> 泛型类 Generic Classes</h2><div class="language-Java line-numbers-mode" data-ext="Java"><pre class="language-Java"><code>public class Test {}
