import{_ as i,c as n,o as a,a as s}from"./app-CnoWjds5.js";const d={};function l(r,e){return a(),n("div",null,e[0]||(e[0]=[s(`<h2 id="开源作者常用做法" tabindex="-1"><a class="header-anchor" href="#开源作者常用做法" aria-hidden="true">#</a> 开源作者常用做法</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>1.git clone // 到本地
