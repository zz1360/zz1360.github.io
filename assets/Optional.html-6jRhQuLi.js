...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li>不建议使用get方法。即使使用ifPresent和get的组合也不是一个好的选择。这样跟直接用if else判断值是否为空没有本质区别。应该使用ifPresentOrElse或者orElseThrow等方法。</li></ul>`,6),s=[t];function r(d,o){return i(),l("div",null,s)}const u=e(a,[["render",r],["__file","Optional.html.vue"]]);export{u as default};
